# Multi-Account Support for ASAF

## Overview

ASAF now supports querying multiple Finout accounts! Users can switch between accounts using a dropdown selector in the header.
...
ASAF: [Shows Production account costs]
```

### After (Multi-Account)
```
User: [Selects "Development" from dropdown]
ASAF: "Account switched! Now querying Development."

User: "What were my costs last month?"
ASAF: [Shows Development account costs]

User: [Switches back to "Production"]
ASAF: "Account switched! Now querying Production."
```

## Benefits

✅ **Multi-Tenant** - One ASAF instance for all accounts
...
Now your whole team can use ASAF to query any account they have access to, all from one interface.
