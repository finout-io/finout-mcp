...
TOOLS_REFERENCE: List[ToolEntry] = [
    ...
    },
    {
        ...
        "when_to_use": [
            ...
            "how many unique resources?",
            "cost efficiency per resource",
        ],
        "example_prompts": [
            "What's the cost per EC2 instance?",
            "How much does each Lambda function cost on average?",
            "Show me cost per resource by service",
            "How many unique instances do we have and what's the cost per unit?",
        ],
        "key_params": [
            "count_dimension (REQUIRED) — dimension to count unique values of",
            "time_period (default: last_30_days)",
            "group_by — break down by dimension",
            "filters, cost_type",
        ],
        "workflow": "search_filters → get_unit_economics",
    },
    {
